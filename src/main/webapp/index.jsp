...
<%@include file="/WEB-INF/jsp/vista/includes/navbar.jsp" %>
  ...
  <div class="my-3 p-3 bg-body rounded shadow-sm">
    ...
    <div class="d-flex text-muted pt-3">
      ...
      <p class="pb-3 mb-0 small lh-sm border-bottom">
        <a href="Controller?accion=listarpro"><b>Productos</b></a>  
      </p>
    </div>
    <div class="d-flex text-muted pt-3">
      ...
      <p class="pb-3 mb-0 small lh-sm border-bottom">
        <a href="Controller?accion=listarodt"><b>Ordenes de trabajo</b></a>  
      </p>
    </div>
  </div>
    ...
    <div class="d-flex text-muted pt-3">
      ...
      <div class="pb-3 mb-0 small lh-sm border-bottom w-100">
        <div class="d-flex justify-content-between">
          <a href="Controller?accion=formulario"><b>Crear nueva orden de trabajo</b></a>  
        </div>
      </div>
    </div>
  </div>
